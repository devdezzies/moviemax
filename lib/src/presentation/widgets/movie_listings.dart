...
class MovieListings extends HookWidget {
  const MovieListings({super.key, required this.movies, required this.whenScrollBottom, required this.hasReachedMax});
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
                onTap: () {}, child: Hero(tag: tag, child: MovieCard(movieDetailEntity: movies?[index],)));
          },
        ),
        //if (!hasReachedMax) const CircularProgressIndicator()
      ],
    );
  }
}
